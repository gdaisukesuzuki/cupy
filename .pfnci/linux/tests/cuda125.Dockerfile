...
\
    ...
    apt-get -qqy --allow-change-held-packages \
            --allow-downgrades install 'libnccl2=2.21.*+cuda12.5' 'libnccl-dev=2.21.*+cuda12.5' 'libcutensor2-cuda-12=2.3.*' 'libcutensor2-dev-cuda-12=2.3.*' 'libcudss0=0.7.1.*' 'libcudss-dev=0.7.1.*'
