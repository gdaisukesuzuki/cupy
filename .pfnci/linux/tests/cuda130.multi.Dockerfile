...
<<<<<<< HEAD
            --allow-downgrades install 'libnccl2=2.27.*+cuda13.0' 'libnccl-dev=2.27.*+cuda13.0' 'libcutensor2-cuda-13=2.3.*' 'libcutensor2-dev-cuda-13=2.3.*' 'libcusparselt0=0.7.1.*' 'libcusparselt-dev=0.7.1.*' 'libcudss0=0.7.1.*' 'libcudss-dev=0.7.1.*'
=======
